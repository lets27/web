...
const Basket = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      {/* Basket Total */}
      {basketItems.length > 0 && (
        <div className="fixed bottom-0 left-0 w-full bg-white shadow-inner p-4 flex justify-center sm:justify-end z-50">
          ...
          <button
            ...
            className="p2 bg-blue-400 cursor-pointer rounded-2xl"
          >
